                    ...
                    using (OleDbCommand cmd = new OleDbCommand(SQl, DB))
                    {
                        using (OleDbDataReader RS = cmd.ExecuteReader())
                        {
                            if(RS.HasRows != true)
                            {
                                for( i = 2; i<= 39; i++)
                                {
                                    m_Combo[i].SelectedItem = m_Combo[i].Items[0];
                                }
                            }
                            else
                            {
                                    ...
                                    if (Conversion.Val(RS["レシピ№"]) != 0) {
                                        ...
                                        switch (i) {
                                            ...
                                            case 2:
                                                ...
                                                m_Combo[19].Text = Convert.ToString(RS["ﾀﾝﾌﾞﾙ"]);
                                                m_Combo[20].Text = Convert.ToString(RS["ISOFIX"]);
                                                m_Combo[21].Text = Convert.ToString(RS["ﾃｻﾞｰ"]);
                                            ...
                                            default:
                                                ...
                                                m_Combo[36].Text = Convert.ToString(RS["ﾀﾝﾌﾞﾙ"]);
                                                m_Combo[37].Text = Convert.ToString(RS["ISOFIX"]);
                                                m_Combo[38].Text = Convert.ToString(RS["ﾃｻﾞｰ"]);
                                        ...
                                        m_c1FlexGrid1[i].SetData(j, 2 , Strings.Right(RS["ST0101"].ToString()  , Strings.Len(RS["ST0101"])   - 1)); // 3
                                        m_c1FlexGrid1[i].SetData(j, 3 , Strings.Right(RS["ST0102"].ToString()  , Strings.Len(RS["ST0102"])   - 1)); // 4
                                        m_c1FlexGrid1[i].SetData(j, 4 , Strings.Right(RS["ST0103"].ToString()  , Strings.Len(RS["ST0103"])   - 1)); // 5
                                        m_c1FlexGrid1[i].SetData(j, 5 , Strings.Right(RS["ST0104"].ToString()  , Strings.Len(RS["ST0104"])   - 1)); // 6
                                        m_c1FlexGrid1[i].SetData(j, 6 , Strings.Right(RS["ST0105"].ToString()  , Strings.Len(RS["ST0105"])   - 1)); // 7
                                        m_c1FlexGrid1[i].SetData(j, 7 , Strings.Right(RS["ST0106"].ToString()  , Strings.Len(RS["ST0106"])   - 1)); // 8
                                        m_c1FlexGrid1[i].SetData(j, 8 , Strings.Right(RS["ST0107"].ToString()  , Strings.Len(RS["ST0107"])   - 1)); // 9
                                        m_c1FlexGrid1[i].SetData(j, 9 , Strings.Right(RS["ST0108"].ToString()  , Strings.Len(RS["ST0108"])   - 1)); // 10
                                        m_c1FlexGrid1[i].SetData(j, 10, Strings.Right(RS["ST0109"].ToString()  , Strings.Len(RS["ST0109"])   - 1)); // 11
                                        m_c1FlexGrid1[i].SetData(j, 11, Strings.Right(RS["ST0110"].ToString()  , Strings.Len(RS["ST0110"])   - 1)); // 12
                                        m_c1FlexGrid1[i].SetData(j, 12, Strings.Right(RS["ST0111"].ToString()  , Strings.Len(RS["ST0111"])   - 1)); // 13
                                        m_c1FlexGrid1[i].SetData(j, 13, Strings.Right(RS["ST0112"].ToString()  , Strings.Len(RS["ST0112"])   - 1)); // 14
                                        m_c1FlexGrid1[i].SetData(j, 14, Strings.Right(RS["ST0113"].ToString()  , Strings.Len(RS["ST0113"])   - 1)); // 15
                                        m_c1FlexGrid1[i].SetData(j, 15, Strings.Right(RS["ST0114"].ToString()  , Strings.Len(RS["ST0114"])   - 1)); // 16
                                        m_c1FlexGrid1[i].SetData(j, 16, Strings.Right(RS["ST0115"].ToString()  , Strings.Len(RS["ST0115"])   - 1)); // 17
                                        m_c1FlexGrid1[i].SetData(j, 17, Strings.Right(RS["ST0116"].ToString()  , Strings.Len(RS["ST0116"])   - 1)); // 18
                                    }
                                }
                            }
                        }
