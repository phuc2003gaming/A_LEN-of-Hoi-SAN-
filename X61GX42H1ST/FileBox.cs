...
namespace X61GX42H1ST
{
    ...
    {
        // プライベート変数
        private static A_MAIN  m_paren = null;
        ...
        static public void VisibleWindow(A_MAIN frm, bool bShow)
        {
            if (bShow == true)
            {
                // フォームの初期化
        ...
        /// </summary>
        static public bool FileOpenCheck(A_MAIN frm)
        {
            DialogResult dr;
