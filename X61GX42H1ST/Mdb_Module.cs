                                            ...
                                            if (RS.HasRows != true)
                                            {
                                                ...
                                                switch (taggp) {
                                                    ...
                                                    case 2:
                                                        ...
                                                        SQl += "'" + Danpre_Xls_sub.GetMasterStr(Danpre_Xls_sub.M_ID.QRG          , dat.LhDat.QRG         ) + "',";
                                                        ...
                                                        SQl += "'" + Danpre_Xls_sub.GetMasterStr(Danpre_Xls_sub.M_ID.Site_Table   , dat.LhDat.Site_Table  ) + "',";
                                                        SQl += "'" + Danpre_Xls_sub.GetMasterStr(Danpre_Xls_sub.M_ID.Robot        , dat.LhDat.Robot       ) + "',";
                                                        SQl += "'" + Danpre_Xls_sub.GetMasterStr(Danpre_Xls_sub.M_ID.Backboard    , dat.LhDat.Backboard   ) + "',";
                                                    ...
                                                    case 5:
                                                        ...
                                                        SQl += "'" + Danpre_Xls_sub.GetMasterStr(Danpre_Xls_sub.M_ID.QRG          , dat.RhDat.QRG         ) + "',";
                                                        ...
                                                        SQl += "'" + Danpre_Xls_sub.GetMasterStr(Danpre_Xls_sub.M_ID.Site_Table   , dat.RhDat.Site_Table  ) + "',";
                                                        SQl += "'" + Danpre_Xls_sub.GetMasterStr(Danpre_Xls_sub.M_ID.Robot        , dat.RhDat.Robot       ) + "',";
                                                        SQl += "'" + Danpre_Xls_sub.GetMasterStr(Danpre_Xls_sub.M_ID.Backboard    , dat.RhDat.Backboard   ) + "',";
                                            ...
                                            else
                                            {
                                                ...
                                                switch (taggp)
                                                {
                                                    ...
                                                    case 2:
                                                        ...
                                                        SQl += "ﾄﾙｸﾚﾝﾁ = '" + Danpre_Xls_sub.GetMasterStr(Danpre_Xls_sub.M_ID.TorqueWrench , dat.LhDat.TorqueWrench) + "',";
                                                        SQl += "ﾗﾝﾊﾞｰ = '"                + Danpre_Xls_sub.GetMasterStr(Danpre_Xls_sub.M_ID.Lumbar, dat.LhDat.Lumbar) + "',";
                                                        SQl += "ﾊﾞｯｸﾎﾟｯｸ = '"                + Danpre_Xls_sub.GetMasterStr(Danpre_Xls_sub.M_ID.BackPock, dat.LhDat.BackPock) + "',";
                                                        SQl += "ﾌｯﾄｳｪﾙﾗﾝﾌﾟ = '"                + Danpre_Xls_sub.GetMasterStr(Danpre_Xls_sub.M_ID.FootwellLamp, dat.LhDat.FootwellLamp) + "',";
                                                        SQl += "ｱｰﾑﾚｽﾄ = '"                + Danpre_Xls_sub.GetMasterStr(Danpre_Xls_sub.M_ID.ArmRest, dat.LhDat.ArmRest) + "',";
                                                        SQl += "QRG = '"                + Danpre_Xls_sub.GetMasterStr(Danpre_Xls_sub.M_ID.QRG, dat.LhDat.QRG) + "',";
                                                        SQl += "ISOFIX = '"                + Danpre_Xls_sub.GetMasterStr(Danpre_Xls_sub.M_ID.ISOFIX, dat.LhDat.ISOFIX) + "',";
                                                        SQl += "ｺﾝﾍﾞﾔﾌｯｸ = '"                + Danpre_Xls_sub.GetMasterStr(Danpre_Xls_sub.M_ID.ConvHook, dat.LhDat.ConvHook) + "',";
                                                        SQl += "ｻｲﾄﾃｰﾌﾞﾙ = '"                + Danpre_Xls_sub.GetMasterStr(Danpre_Xls_sub.M_ID.Site_Table, dat.LhDat.Site_Table) + "',";
                                                        SQl += "ﾛﾎﾞｯﾄ = '"                + Danpre_Xls_sub.GetMasterStr(Danpre_Xls_sub.M_ID.Robot, dat.LhDat.Robot) + "',";
                                                        SQl += "ﾊﾞｯｸﾎﾞｰﾄﾞ = '"                + Danpre_Xls_sub.GetMasterStr(Danpre_Xls_sub.M_ID.Backboard, dat.LhDat.Backboard) + "',";
                                ...
                                if(RS["識別コード"].ToString().Length > 1) {
                                    ...
                                    switch (taggp) {
                                        ...
                                        case 2:
                                            ...
                                            wrk.RhDat.TorqueWrench = (UInt16)Conversion.Val(Strings.Left(RS["ﾄﾙｸﾚﾝﾁ"].ToString(), Strings.InStr(RS["ﾄﾙｸﾚﾝﾁ"].ToString(), ":") - 1));
                                            wrk.RhDat.Lumbar = (UInt16)Conversion.Val(Strings.Left(RS["ﾗﾝﾊﾞｰ"].ToString(), Strings.InStr(RS["ﾗﾝﾊﾞｰ"].ToString(), ":") - 1));
                                            wrk.RhDat.BackPock = (UInt16)Conversion.Val(Strings.Left(RS["ﾊﾞｯｸﾎﾟｯｸ"].ToString(), Strings.InStr(RS["ﾊﾞｯｸﾎﾟｯｸ "].ToString(), ":") - 1));
                                            ...
                                            wrk.RhDat.QRG = (UInt16)Conversion.Val(Strings.Left(RS["QRG"].ToString(), Strings.InStr(RS["QRG"].ToString(), ":") - 1));
                                            ...
                                            wrk.RhDat.Site_Table = (UInt16)Conversion.Val(Strings.Left(RS["ｻｲﾄﾞﾃｰﾌﾞﾙ"].ToString(), Strings.InStr(RS["ｻｲﾄﾞﾃｰﾌﾞﾙ"].ToString(), ":") - 1));
                                            wrk.RhDat.Robot = (UInt16)Conversion.Val(Strings.Left(RS["ﾛﾎﾞｯﾄ"].ToString(), Strings.InStr(RS["ﾛﾎﾞｯﾄ"].ToString(), ":") - 1));
                                            wrk.RhDat.Backboard = (UInt16)Conversion.Val(Strings.Left(RS["ﾊﾞｯｸﾎﾞｰﾄﾞ"].ToString(), Strings.InStr(RS["ﾊﾞｯｸﾎﾞｰﾄﾞ"].ToString(), ":") - 1));
                                            ...
                                            if (RS["ｺﾝﾋﾞﾆﾌｯｸ"].ToString() != "") {
                                                ...
                                                wrk.LhDat.Site_Table = (UInt16)Conversion.Val(Strings.Left(RS["ｻｲﾄﾞﾃｰﾌﾞﾙ"].ToString(), Strings.InStr(RS["ｻｲﾄﾞﾃｰﾌﾞﾙ"].ToString(), ":") - 1));
                                            }
                                            else {
                                                wrk.LhDat.ConvHook  = 0;
                                                wrk.LhDat.Site_Table = 0;
                                            }
